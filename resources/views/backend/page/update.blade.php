<?php $schema_num = count($page->schema) ?>
<x-post-layout>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{route('admin.page.update',$page->id)}}" method="POST" class="card-body" enctype="multipart/form-data">
                        @csrf
                        @method('put')


                        <div class="form-group">
                            <textarea class="form-control tinymce" name='content' id="content" placeholder="Enter content">{{$page->content}}</textarea>
                            @error('content')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input_fields_wrap">
                                ...
                                @for ($i=0; $i <= $schema_num; $i++)                        
                                    <div class="p-2">
                                        <input type="text" class="form-control" name='schema[{{ $i }}][key]' value="{{$page->schema[$i]['key'] ?? ''}}" id="schema" placeholder="Enter schema"/>
                                        <input type="text" class="form-control" name='schema[{{ $i }}][value]' value="{{$page->schema[$i]['value'] ?? ''}}" id="schema" placeholder="Enter schema"/>
                                    </div>
                                @endfor
                            </div>
                            @error('schema')
                        ...
                        <section class="form-content">
                            <section class="seo-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name='telephone' value="{{$page-> telephone}}" id="telephone" placeholder="Enter telephone">
                                    @error('telephone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <section class="main-photo">
                                ...
                                <div class="ml-2 col-sm-12">
                                    <img src="{{ asset('images/posts')}}/{{$page -> photo}}" id="preview" class="img-thumbnail">
                                </div>
                            </section>
                        </section>
