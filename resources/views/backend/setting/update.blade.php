        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{route('admin.users.update',$user->id)}}" method="POST" enctype="multipart/form-data" class="card-body">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-radio-label">
                                <input class="form-radio-input" type="radio" name="is_admin" value="0"  {{!($user->isAdmin()) ? 'checked' : ''}}>
                                <span class="form-radio-sign">User</span>
                            </label>
                            <label class="form-radio-label ml-3">
                                <input class="form-radio-input" type="radio" name="is_admin" value="1" {{$user->isAdmin() ? 'checked' : ''}} >
                                <span class="form-radio-sign">Admin</span>
                            </label>
                        </div>
                        <div class="form-group">
                            <label for="photo">Update Your Photo</label>
                            <input type="file" name='photo' value="{{$user -> photo}}"  class="form-control-file" id="photo">
                            @error('photo')
